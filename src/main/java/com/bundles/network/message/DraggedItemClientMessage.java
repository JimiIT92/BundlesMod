 ...
 * @author JimiIT92
 */
public class DraggedItemClientMessage {
     ...
     * Default Constructor.
     */
    public DraggedItemClientMessage() {
     ...
     */
    public DraggedItemClientMessage(ItemStack stack) {
     ...
     * @return Message
     */
    public static DraggedItemClientMessage decode(PacketBuffer buffer) {
        DraggedItemClientMessage message = new DraggedItemClientMessage();
